...
class Garage(models.Model):
    ...
    name = models.CharField(verbose_name="Name", max_length=100, null=False, blank=True)
    nip_number = models.CharField(verbose_name="NIP Number", max_length=10, null=False, blank=True)
